...
import {SignedInHeaderComponent} from "./signedInHeaderComponent";
import {Company, User} from "~/utilities/typeDefinitions";

export function PageScaffold2({user, accessibleCompanies, currentCompany, children}: {user: User; accessibleCompanies: Array<Company>; currentCompany: Company; children}) {
