...
export const loader: LoaderFunction = async ({request, params}) => {
    ...
    const loaderData: LoaderData = {
        ...
        facebookAdsData: await getFacebookAdsLectrixData(minDate, maxDate, selectedGranularity, companyId),
        companyId: companyId,
    };
...
export default function () {
    const {appliedSelectedGranularity, appliedMinDate, appliedMaxDate,facebookAdsData, companyId} =
        ...
        <>
            <div className="tw-grid tw-grid-cols-12 tw-gap-x-6 tw-gap-y-6 tw-p-8">
                <DateFilterSection
                    ...
                    page={`/${companyId}/facebook-ads-simplified`}
                />
